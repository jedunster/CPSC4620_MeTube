...
<?php $category = getCategoryFromMedia($_GET['id']);?>
                        <option <?php if($category === "Funny") echo "selected"; ?>>Funny</option>
                        <option <?php if($category === "Music") echo "selected"; ?>>Music</option>
                        <option <?php if($category === "Sports") echo "selected"; ?>>Sports</option>
                        <option <?php if($category === "Informative") echo "selected"; ?>>Informative</option>
                ...
                <input value="<?php echo get_media_keywords($_GET['id']); ?>"  name="keywords" type="text" id="keywords" class="form-control" style="width: 550px;">
...
<br><br>
<input id="submitBtn" style="margin-left: 0px;" value="Save Changes" name="submit" type="submit" class="btn btn-primary"/>
